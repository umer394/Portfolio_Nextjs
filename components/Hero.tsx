...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        ...
        />
        <Spotlight
        className='top-40 left-full h-[80vh] w-[50vw]'fill='purple'
        />
        <Spotlight
        ...
        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                <h2 className='uppercase tracking-widest text-xs text-center text-white max-w-80'>Dynamic Web Magic with Next.JS</h2>
                <TextGenerateEffect
                ...
                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl text-white'>
                    Hi, I&apos;m Umer, a Next.js Developer based in Pakistan
                </p>
