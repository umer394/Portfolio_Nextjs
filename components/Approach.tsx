...
export const Approach =()=> {
  return (
    <section className="w-full py-20" id="contact">
        ...
        <Card title="Plannig and Strategy" icon={<AceternityIcon order="Phase 1"/>}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        ...
        <h3 className="text-sm dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center" style={{color: '#e4ecff'}}>
          {description}
        </h3>
      </div>
    </div>
